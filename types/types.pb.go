...
type ResponseInfo struct {
	...
	State  *StateInfo  `protobuf:"bytes,2,opt,name=state" json:"state,omitempty"`
	Config *ConfigInfo `protobuf:"bytes,3,opt,name=config" json:"config,omitempty"`
}
...
func (m *ResponseInfo) GetState() *StateInfo {
	if m != nil {
		return m.State
	}
	return nil
...
func (*StateInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *StateInfo) GetBlockHeight() uint64 {
	if m != nil {
...
func (m *StateInfo) GetAppHash() []byte {
	if m != nil {
		return m.AppHash
	}
	return nil
...
func (*ConfigInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func init() {
	...
	proto.RegisterType((*StateInfo)(nil), "types.StateInfo")
...
var fileDescriptor0 = []byte{
	...
	,
}
